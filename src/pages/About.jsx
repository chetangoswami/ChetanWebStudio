    ...
    <div className="pt-32 pb-24 px-4 md:px-8 lg:px-12 min-h-screen relative overflow-hidden bg-background">
      ...
      <div className="max-w-screen-xl mx-auto w-full relative z-10">
        ...
        <div className="mb-24 border-b-2 border-border pb-12">
          <h1 className="text-6xl md:text-8xl lg:text-9xl font-black uppercase tracking-tighter mb-8 font-heading leading-[0.85] break-words">
        ...
        <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-start">
          ...
          <div className="flex flex-col gap-12 md:gap-16">
            <div className="border border-border p-8 md:p-12 bg-primary brutalist-shadow transition-transform hover:-translate-y-1 hover:-translate-x-1 duration-300">
          ...
          <div className="flex flex-col gap-12 md:gap-16">
            ...
            <div className="grid grid-cols-2 gap-4 mt-8">
              <div className="border border-border p-6 flex flex-col justify-center items-center bg-primary">
